...
- `@iits-kumo-ops/addons` - Addon descriptions and translations
- `@iits-kumo-ops/offer-description` - Offer description locale files
- `@iits-kumo-ops/onepager-opentelekomcloud` - OpenTelekomCloud onepager locale files
